        ...
        storyList.append(`
            <div class="row mb-4">
                ...
                <div class="col-12 mt-2">
                    <button class="btn  text-white btn-edit" data-id="${id}" style="background-color: rgb(21, 14, 73);">Edit</button>
                    <button class="btn  text-white btn-delete" data-id="${id}" style="background-color: rgb(21, 14, 73);">Delete</button>
                </div>
            </div>
            <hr />
        `);
